...
let _historial = [], "Junio": "📌 LÍNEA EDITORIAL JUNIO 2026\n\nS1 (1-7): Mundial + Turismo\nS2 (8-14): Partido México 11 jun\nS3 (15-21): Día del Padre\nS4 (22-28): Orgullo LGBTQ+\nCierre: Adelanto julio", "Junio": "📌 LÍNEA EDITORIAL JUNIO 2026\n\nS1 (1-7): Mundial + Turismo\nS2 (8-14): Partido México 11 jun\nS3 (15-21): Día del Padre\nS4 (22-28): Orgullo LGBTQ+\nCierre: Adelanto julio"};
...
export default function App() {
  ...
  const [parrillas, setParrillas] = useState({"Mayo": buildMayo(), "Junio": buildJunio()});
  const [resenas, setResenas] = useState({"Mayo": [], "Junio": buildResenasJunio()});
  const [briefings, setBriefings] = useState(BRIEFINGS_INIT);
  const [mesesDisp, setMesesDisp] = useState(["Mayo","Junio"]);
